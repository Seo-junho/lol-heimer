...
const SkeletonMatchCard: React.FC = () => {
	...
	return (
		<div className={`shadow-lg mb-5 w-full p-10 flex flex-col sm:flex-row items-center justify-center bg-gray-100 border border-white rounded-xl`}>
			<div className="animate-pulse flex-grow-0 flex flex-col sm:flex-row justify-center items-center mx-auto">
				<div className="flex sm:flex-col justify-center items-center mt-1">
					<div className="sm:pb-2 bg-gray-300 w-10 h-5"></div>
					<div className={`px-3 font-bold bg-gray-300 w-6 h-5 my-1`}></div>
					<div className="bg-gray-300 w-12 h-5"></div>
				</div>
				...
				<div className="px-5 flex flex-col justify-center items-center">
					<div className="bg-gray-300 w-32 h-7 mt-1"></div>
					<div className="bg-gray-300 w-32 h-7 mt-1"></div>
					<div className="bg-gray-300 w-32 h-5 mt-1"></div>
				</div>
				<div className="flex flex-col justify-center items-center py-3">
					<div className="bg-gray-300 w-24 h-4 mt-1"></div>
					<div className="bg-gray-300 w-24 h-4 mt-1"></div>
				</div>
				<div className="mx-3">
